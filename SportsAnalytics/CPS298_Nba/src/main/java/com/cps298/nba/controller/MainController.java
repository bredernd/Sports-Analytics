...
public class MainController {
	...
	public String gameFacts(@RequestParam("gameId") int gameId, Model model) {
	    GameSechedule game = imp.getGameSchedule(gameId);
	    String homeTeam = game.getHome_team().getTeamId();
	    String awayTeam = game.getAway_team().getTeamId();
	    List<TeamPlayers> homePlayers = imp.getTeamPlayers(homeTeam);
	    model.addAttribute("homePlayers",homePlayers);
	    List<TeamPlayers> awayPlayers = imp.getTeamPlayers(awayTeam);
